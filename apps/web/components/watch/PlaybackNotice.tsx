...
export function PlaybackNotice({ source }: { source: WatchSource | null }) {
  ...
  const notices = [
    ...
    source.requiresReferrer ? "This source declares a custom referrer that browsers cannot reliably provide." : null,
    source.requiresUserAgent ? "This source declares a custom user agent that browsers cannot override." : null,
