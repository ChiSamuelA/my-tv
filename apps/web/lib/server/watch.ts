...
import { getRelatedChannels } from "./related-channels";
...
export async function getWatchPageData(id: string, params: WatchSearchParams): Promise<WatchPageData | null> {
  ...
  data.relatedChannels = await getRelatedChannels(channel);
...
export type { SelectedPlaybackSource, WatchPageData, WatchRelatedChannel, WatchSource } from "./watch-model";
